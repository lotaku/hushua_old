...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field not_dos on 'HsInfo'
        m2m_table_name = db.shorten_name(u'hs_info_hsinfo_not_dos')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field not_dos on 'HsInfo'
        db.delete_table(db.shorten_name(u'hs_info_hsinfo_not_dos'))
