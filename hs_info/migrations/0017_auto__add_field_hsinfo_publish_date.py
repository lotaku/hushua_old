...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HsInfo.publish_date'
        db.add_column(u'hs_info_hsinfo', 'publish_date',
                      self.gf('django.db.models.fields.DateField')(default='2014-09-14'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HsInfo.publish_date'
        db.delete_column(u'hs_info_hsinfo', 'publish_date')
    ...
    models = {
        ...
        u'hs_info.hsinfo': {
            ...
            'publish_date': ('django.db.models.fields.DateField', [], {'default': "'2014-09-14'"}),
