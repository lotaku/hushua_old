...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(m2m_table_name, ['hsinfo_id', 'user_id'])
    ...
    models = {
        ...
        u'hs_info.hsinfo': {
            ...
            'not_do': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'users+'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
