...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notdo.hsinfo'
        db.delete_column(u'hs_info_notdo', 'hsinfo_id')
    ...
    def backwards(self, orm):
        # Adding field 'Notdo.hsinfo'
        db.add_column(u'hs_info_notdo', 'hsinfo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hs_info.HsInfo'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'hs_info.hsinfo': {
            ...
            'not_do': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['hs_info.Notdo']", 'symmetrical': 'False'}),
