...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotDo.notdo_id'
        db.add_column(u'hs_info_notdo', 'notdo_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotDo.notdo_id'
    ...
    models = {
        ...
        u'hs_info.hsinfo': {
            ...
            'not_do': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'NotDo+'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['hs_info.NotDo']"}),
        ...
        u'hs_info.notdo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notdo_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        }
    }
