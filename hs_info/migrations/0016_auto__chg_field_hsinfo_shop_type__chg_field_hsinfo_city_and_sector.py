...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'hs_info_hsinfo', 'city_and_sector', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))

    def backwards(self, orm):

        # Changing field 'HsInfo.shop_type'
        db.alter_column(u'hs_info_hsinfo', 'shop_type', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))
    ...
    models = {
        ...
        u'hs_info.hsinfo': {
            ...
            'city_and_sector': ('django.db.models.fields.CharField', [], {'max_length': '8', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'not_dos': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['hs_info.Notdo']", 'symmetrical': 'False'}),
