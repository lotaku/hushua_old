...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Notdo2'
        db.create_table(u'hs_info_notdo2', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('choice', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('hsinfo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hs_info.HsInfo'], null=True)),
        ))
        db.send_create_signal(u'hs_info', ['Notdo2'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Notdo2'
        db.delete_table(u'hs_info_notdo2')
    ...
    models = {
        ...
        u'hs_info.notdo2': {
            'Meta': {'object_name': 'Notdo2'},
            'choice': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'hsinfo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['hs_info.HsInfo']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }
